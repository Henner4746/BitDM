...
const Map<String, Map<String, String>> strings = {
  'en': {
    ...
    'pushStep4Sub': 'Here under Receiving. ntfy will then show a subscription starting with "up" — that is BitDM. Leave it alone.',
 ...
 'waiting': 'Waiting for device',
  ...
  'de': {
    ...
    'pushStep4Sub': 'Hier unter Empfang. In ntfy erscheint danach ein Abo, das mit „up" anfängt — das ist BitDM. Nicht anfassen.',
