...
const Map<String, Map<String, String>> strings = {
  'en': {
    ...
    'bgPushNote': 'The cheapest option: nothing runs until something arrives. Instead of BitDM holding a connection, a push app on your phone does — and it does that for every app that uses it. Needs the ntfy app installed (F-Droid or Play Store). NOT Google: the nudge goes through push.bitdm.net, the same operator as the relay. Google is not involved at any point.',
 ...
 'waiting': 'Waiting for device',
  ...
  'de': {
    ...
    'bgPushNote': 'Das Sparsamste: es läuft nichts, bis etwas ankommt. Statt dass BitDM eine Verbindung hält, tut das eine Push-App auf deinem Telefon — und die tut es für alle Apps, die sie nutzen. Braucht die ntfy-App (F-Droid oder Play Store). NICHT Google: der Anstoß läuft über push.bitdm.net, denselben Betreiber wie der Relay. Google ist an keiner Stelle beteiligt.',
