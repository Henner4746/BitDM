...
const Map<String, Map<String, String>> strings = {
 ...
 'waiting': 'Waiting for device',
    ...
    'torTitle': 'Connect via Tor', 'torSub': 'Everything to the relay and the attachment store goes through Orbot (SOCKS5 on 127.0.0.1:{port}). The relay then no longer sees your IP address. Orbot must be running; nearby mode is not affected.',
 ...
 'waiting': 'Warte auf Gerät',
    ...
    'torTitle': 'Über Tor verbinden', 'torSub': 'Alles zum Relay und ins Zwischenlager geht über Orbot (SOCKS5 auf 127.0.0.1:{port}). Der Relay sieht dann deine IP-Adresse nicht mehr. Orbot muss laufen; der Nahbereich ist davon nicht betroffen.',
